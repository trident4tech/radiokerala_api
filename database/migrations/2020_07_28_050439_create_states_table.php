...
class CreateStatesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('states', function (Blueprint $table) {
            $table->bigincrements('state_id')->comment('The primary key field of the table');
            $table->unsignedInteger('dist_id');
        
            $table->text('state_name')->comment('Name of the State');
            $table->smallInteger('status')->default(2)->comment('The status of the State: 2=> Enabled , 1=>Disabled');
      ...
      DB::statement("COMMENT ON TABLE states IS 'Table for managing states'");
