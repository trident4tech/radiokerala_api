...
class CreatePriceTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('price', function (Blueprint $table) {
            $table->bigincrements('price_id')->comment('primary key of table');
            $table->text('price_class_id')->nullable()->comment('foreign key to class table');
            $table->text('price_base_rate')->nullable()->comment('rate of class');
            $table->date('price_from_date')->nullable()->comment('from date');
            $table->date('price_to_date')->nullable()->comment('to date');
