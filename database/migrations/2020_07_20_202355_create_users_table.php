...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->bigincrements('id')->comment('The primary key field of the table');
            $table->text('usr_name')->comment('Name of the user');
            $table->text('usr_mobile')->unique()->comment('Mobile No. of the user');
            $table->text('email')->unique()->comment('Mobile No. of the user');
            $table->text( 'usr_pass')->comment('Password of the user');
