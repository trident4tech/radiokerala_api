...
class CreateUsergroupsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('usergroups', function (Blueprint $table) {
            $table->bigincrements('ugrp_id')->comment('The primary key field of the table');
            $table->text('ugrp_name')->comment('Name of the User Group');
            $table->smallInteger('status')->default(2)->comment('The status of the user group: 2=> Enabled , 1=>Disabled');
        ...
        DB::statement("COMMENT ON TABLE usergroups IS 'Table for managing usergroups'");
